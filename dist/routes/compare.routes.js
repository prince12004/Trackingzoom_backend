...
const controller = __importStar(require("../controllers/compare.controller"));
const router = (0, express_1.Router)();
router.use(guestId_1.ensureGuestId, auth_1.optionalCustomerAuth);
router.get('/', controller.getCompareList);
router.post('/', [(0, express_validator_1.body)('productId').isMongoId()], validate_1.validate, controller.addToCompare);
