...
const controller = __importStar(require("../controllers/address.controller"));
...
router.post('/', [
    ...
    (0, express_validator_1.body)('pincode').matches(/^[1-9][0-9]{5}$/),
], validate_1.validate, controller.createAddress);
